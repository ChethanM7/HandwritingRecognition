...
def infer(model, fnImg):
    ...
    #im=Image.open(r"../data/testImage2.png")
    #im.show()
    #import matplotlib.pyplot as plt
    #import matplotlib.image as mpimg
    #img=mpimg.imread('../data/testImage2.png')
    #imgplot=plt.imshow(img)
    #plt.show()
    #print("Here is your digital text")
    print("\n\n\n")
    print("DIGITAL TEXT: "+"\033[1m"+recognized[0])
    print("AUTOCORRECT : "+"\033[1m"+correct_sentence(recognized[0]))
    print("\n\n\n\n\n\n\n\n\n")
